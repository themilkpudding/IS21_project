...
3.Требования к игровым персонажам.
    ...
    3.1 Герой
        ...
        * Герой - игровой персонаж, которым управляет игрок. Имеет 2 вида ударов. Имеет способность использовать щит, броню. Имеет ульту(зависит от класса героя). Игрок начинает управлять героем, сразу после успешной авторизации.
        Здоровье: 20
        Жизней: 3
            3.1.1.1 Классы
        ...
        * Игрок может управлять героем:
            ...
            * Клавиша F (Кнопка "Удар") - герой наносит удар мечом или выстреливает из лука. (смотря какой слот выбран)
    ...
    3.2 Монстры
        ...
        * Монстры имеют простеиший интеллект - Бегут в сторону игрока. Обходят препятствия.
    ...
    4.1. Стартовый экран
        ...
        * Центральная панель (сверху вниз):
        ...
        4.1.4. Функциональные требования
			...
			* В любое поле ввода можно вводить любые символы.
            ...
            * Если пользователь поставил кнопку "Не выходить из учетной записи" в состояние Вкл, и нажал кнопку "Продолжить", при следующем заходе в приложение, авторизация производится автоматически (по старым данным). 
    ...
    4.2 Экран регистрации
        ...
        * Центральная панель (сверху вниз):
        ...
        4.2.3. Сценарии развития
            ...
            Условие: введен незарегистрированный Логин. 
            Основной поток:
